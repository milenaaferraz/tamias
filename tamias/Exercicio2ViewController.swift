...
class Exercicio2ViewController:UIViewController {
    ...
    let listaDeSequencias: [[Int]] = [[1,2,3,4], [1,2,4,3], [1,3,2,4],
                                      [1,3,4,2], [1,4,3,2], [1,4,2,3], [2,1,3,4], [2,1,4,3], [2,3,1,4],
                                      [2,3,4,1], [2,4,1,3], [2,4,3,1], [3,1,2,4], [3,1,4,2], [3,2,1,4],
                                      [3,2,4,1], [3,4,1,2], [3,4,2,1], [4,1,2,3], [4,1,3,2], [4,2,1,3],
    ...
    @IBAction func click(_ sender: Any) {
        ...
        if flor1.isHidden && flor2.isHidden && flor3.isHidden &&
            flor4.isHidden {
